...
const SpotRanking = () => {
  ...
  // Fetch todas as moedas disponíveis no mercado Spot
  useEffect(() => {
  ...
  return (
    <div className="container mt-5 mb-5">
      <h2 className="text-center">General Market Ranking (Spot Market - Current daily close)</h2>
      <button
